...
Check the reprt in documents for addtional inforamttion of project and and check video in video demo file how the app works. 
To this project cerate an .env file with fields 
# .env file feilds
PORT=
